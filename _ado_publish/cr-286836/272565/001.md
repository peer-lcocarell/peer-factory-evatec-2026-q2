...
The tester verifies that a valid work order file imports successfully with correct required and optional mappings and that imported work orders are immediately available for downstream usage.
