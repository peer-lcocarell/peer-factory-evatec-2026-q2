...
| 4 | Open Logbook and Magnet System History views. | Corresponding install/uninstall entries exist and remain linked/synchronized. |

## Expected Outcome
Hardware Configuration History, Logbook, and Magnet System History remain synchronized and accurately reflect the change.
