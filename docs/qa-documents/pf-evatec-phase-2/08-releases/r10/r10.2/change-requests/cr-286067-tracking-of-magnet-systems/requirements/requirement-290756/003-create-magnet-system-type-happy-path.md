...
| 4 | Save the new Magnet System Type. | The record is saved successfully. |
| 5 | Return to or refresh the list page. | The new Magnet System Type appears in the list with the entered values and expected status. |

## Expected Outcome
A user with `MagnetSystemTypes_Edit` permission can create a new Magnet System Type from the list page. The record is persisted and visible in the list with expected values.
